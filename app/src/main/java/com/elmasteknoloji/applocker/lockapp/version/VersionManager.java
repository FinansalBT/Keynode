package com.colornative.lockapp.version;
...
public class VersionManager {
    ...
    private static final String PREFS_FILENAME = "com.colornative.update";

    private static final String PREFS_VERSION_MATCHED = "com.colornative.update.version";
    /**
     * This version is OR WILL BE deprecated
     */
    private static final String PREFS_DEPRECATED = "com.colornative.update.deprecated";
    /**
     * This version's deprecation time
     */
    private static final String PREFS_DEPRECATION_TIME = "com.colornative.update.deprecation_time";
    /**
     * If server time >= warning time, the user should get warned
     */
    private static final String PREFS_WARN_TIME = "com.colornative.update.warn_before_time";
    /**
     * Current server time
     */
    private static final String PREFS_SERVER_TIME = "com.colornative.update.server_time";
    /**
     * Custom prefix to be added to user-defined objects
     */
    private static final String PREFS_VALUES_PREFIX = "com.colornative.update.values.custom.";

    // Prefs in persistent file will not be wiped when a new version is applied
    // from server
    private static final String PERSISTENT_FILENAME = "com.colornative.update.pers";
    /**
     * The url to query for version info
     */
    private static final String PREFS_URL = "com.colornative.update.url";

    /**
     * This indicates the old version for #isJustUpdated()
     */
    private static final String PREFS_OLD_VERSION = "com.colornative.update.values.old_version";
