package com.colornative.components;
...
import com.colornative.components.VersionChecker.VersionInfo;
...
public class VersionChecker extends AsyncTask<String, Void, VersionInfo> {
	...
	private static final String PREF_KEY_DEPRECATED_VERSION = "com.colornative.components.version.deprecated_version";
	private static final String PREF_KEY_AVAILABLE_VERSION = "com.colornative.components.version.current_version";
	private static final String PREF_KEY_LAST_CHECK = "com.colornative.components.version.last_check";
...
//			mPrefsCurrentVersion = vi.current;
	...
	private static boolean check(VersionInfo vi, String checkSum) {
		try {
			...
			// The VersionInfo
			byte[] viInputBytes = ("com.colornative.plugin " + vi.current + " " + vi.deprecated)
					.getBytes("UTF-8");
