package com.colornative.plugin.lock;
...
import com.colornative.plugin.ui.MainActivity;
import com.colornative.plugin.util.PrefUtils;
import com.colornative.plugin.version.VersionManager;
import com.colornative.plugin.version.VersionUtils;
...
public class AppLockService extends Service {
     ...
     * and is running
     */
    public static final String BROADCAST_SERVICE_STARTED = "com.colornative.plugin.intent.action.service_started";
    /**
     * Sent to {@link MainActivity} when the service has been stopped
     */
    public static final String BROADCAST_SERVICE_STOPPED = "com.colornative.plugin.intent.action.service_stopped";
    /**
     ...
     */
    public static final String CATEGORY_STATE_EVENTS = "com.colornative.plugin.intent.category.service_start_stop_event";
     ...
     */
    private static final String ACTION_STOP = "com.colornative.plugin.intent.action.stop_lock_service";
    /**
     * Starts the alarm
     */
    private static final String ACTION_START = "com.colornative.plugin.intent.action.start_lock_service";
    /**
     ...
     */
    private static final String ACTION_RESTART = "com.colornative.plugin.intent.action.restart_lock_service";

    private static final String EXTRA_FORCE_RESTART = "com.colornative.plugin.intent.extra.force_restart";
