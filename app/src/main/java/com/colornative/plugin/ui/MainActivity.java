package com.colornative.plugin.ui;

import com.colornative.plugin.lock.AppLockService;
import com.colornative.plugin.lock.LockService;
import com.colornative.plugin.ui.NavigationFragment.NavigationListener;
import com.colornative.plugin.util.PrefUtils;
import com.colornative.components.DialogSequencer;
...
//			: VERSION_URL_PRD;
	private static final String EXTRA_UNLOCKED = "com.colornative.plugin.unlocked";
